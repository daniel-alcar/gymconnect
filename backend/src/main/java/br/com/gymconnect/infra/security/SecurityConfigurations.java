    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception{
        return httpSecurity
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.PUT, "/cronograma/**").hasAuthority("CLIENTE")
                .requestMatchers(HttpMethod.DELETE, "/cronograma/**").hasAuthority("CLIENTE")
                ...
                .requestMatchers(HttpMethod.PUT, "/cronogramaexercicio/**").hasAuthority("CLIENTE")
                ...
                .requestMatchers(HttpMethod.POST, "/chat/coach").authenticated()
